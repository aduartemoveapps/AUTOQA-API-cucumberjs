...
const { Given, When, Then, Before, After, JsonFormatter } = require('@cucumber/cucumber');
...
After(() => {
  ...
  console.log("Fin Scenario");
  // console.log("Respomnse",spec.response());
  // console.log("Respomnse",spec.inspect());
